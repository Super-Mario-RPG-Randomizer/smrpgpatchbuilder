...
script = EventScript([
	PaletteSet(palette_set_starts_at=110, from_row=NPC_PALETTE_ROW_7),
	...
	FadeInFromBlack(sync=False),
	Return(),
	PaletteSet(palette_set_starts_at=109, from_row=NPC_PALETTE_ROW_4, identifier="EVENT_737_palette_set_22"),
