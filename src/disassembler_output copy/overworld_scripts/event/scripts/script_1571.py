...
script = EventScript([
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=49, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=50, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=51, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=52, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=53, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=54, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=55, row=LEVEL_PALETTE_7),
	Pause(16),
