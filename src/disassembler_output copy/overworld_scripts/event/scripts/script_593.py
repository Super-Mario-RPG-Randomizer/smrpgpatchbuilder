...
script = EventScript([
	...
	PaletteSet(palette_set_starts_at=81, from_row=MARIO_PALETTE),
	PaletteSet(palette_set_starts_at=82, from_row=NPC_PALETTE_ROW_4),
	PaletteSet(palette_set_starts_at=83, from_row=NPC_PALETTE_ROW_5),
	Pause(2),
	...
	DarkenLayersExceptPaletteRows(fade_depth=25, duration_frames=30, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2, NPC_PALETTE_ROW_3, NPC_PALETTE_ROW_4, NPC_PALETTE_ROW_5, NPC_PALETTE_ROW_6, NPC_PALETTE_ROW_7]),
	PauseScriptUntilEffectDone(),
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=86, row=NPC_PALETTE_ROW_4),
	Pause(30),
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=84, row=MARIO_PALETTE),
	Pause(30),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=85, row=NPC_PALETTE_ROW_5),
	RememberLastObject(),
	Pause(370),
	PauseActionScript(NPC_9),
	...
	UnknownCommand(bytearray([0xFD, 0x8C, 0x32, 0x0A, 0x30])),
	SetSyncActionScript(NPC_9, A0120_EMBEDDED_ROUTINE),
	Pause(180),
	PauseActionScript(NPC_9),
	ActionQueueSync(target=NPC_9, subscript=[
	...
	ActionQueueSync(target=MARIO, subscript=[
		...
		A_UnknownCommand(bytearray([0x25, 0x00, 0x04, 0xF0, 0xFF])),
		A_SetWalkingSpeed(SLOW),
		A_WalkSouthSteps(2),
		A_WalkSouthPixels(4),
		A_FloatingOff(),
	...
	Pause(160),
	DarkenLayersExceptPaletteRows(fade_depth=0, duration_frames=40, preserve_rows=[NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2, NPC_PALETTE_ROW_3, NPC_PALETTE_ROW_6, NPC_PALETTE_ROW_7]),
	RememberLastObject(),
	SetSyncActionScript(NPC_9, A0120_EMBEDDED_ROUTINE),
	Pause(90),
	PauseActionScript(NPC_9),
