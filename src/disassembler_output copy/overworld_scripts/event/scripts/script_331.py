...
script = EventScript([
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=41, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=42, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=43, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=44, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=45, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=46, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=47, row=LEVEL_PALETTE_7),
	...
	Set0158Bit7Offset(0x015A),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=17, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=18, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=19, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=20, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=21, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=22, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=23, row=LEVEL_PALETTE_7),
