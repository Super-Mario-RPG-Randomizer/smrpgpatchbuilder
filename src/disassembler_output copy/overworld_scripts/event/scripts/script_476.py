...
script = EventScript([
	...
	DarkenLayersExceptPaletteRows(fade_depth=0, duration_frames=1, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_4, NPC_PALETTE_ROW_5, NPC_PALETTE_ROW_7]),
	PauseScriptUntilEffectDone(),
	...
	CloseDialog(),
	JmpIfBitClear(MARRYMORE_LIBERATED, ["EVENT_476_darken_layers_except_palette_rows_190"]),
	SummonObjectToCurrentLevel(NPC_13),
	DarkenLayersExceptPaletteRows(fade_depth=50, duration_frames=30, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_4, NPC_PALETTE_ROW_5, NPC_PALETTE_ROW_7], identifier="EVENT_476_darken_layers_except_palette_rows_190"),
	ActionQueueSync(target=NPC_10, subscript=[
		A_FaceNorthwest(),
		A_VisibilityOn()
	]),
