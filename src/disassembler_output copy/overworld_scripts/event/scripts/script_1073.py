...
script = EventScript([
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_SetSubroutineXTargets(512, 65280),
		A_Pause(16),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=64, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(256, 65152),
		A_Pause(16),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(0, 65195),
		A_Pause(24),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=96, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(65366, 65110),
		A_Pause(24),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=96, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(65195, 65024),
		A_Pause(24),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(65152, 65088),
		A_Pause(32),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=128, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(65024, 65024),
		A_Pause(32),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=96, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(512, 65451),
		A_Pause(24),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=96, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(853, 85),
		A_Pause(24),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=96, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(1024, 170),
		A_Pause(24),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=128, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(896, 192),
		A_Pause(32),
		A_BPL262728()
	]),
	Return(),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=128, silent=True),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(1024, 256),
		A_Pause(32),
		A_BPL262728()
	]),
	Return()
