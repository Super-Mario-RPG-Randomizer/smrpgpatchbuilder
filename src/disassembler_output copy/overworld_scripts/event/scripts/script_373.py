...
script = EventScript([
	...
	Store02To0248(),
	DarkenLayersExceptPaletteRows(fade_depth=25, duration_frames=30, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2, NPC_PALETTE_ROW_3]),
	Pause(60),
	Store00To0248(),
	...
	RememberLastObject(),
	DarkenLayersExceptPaletteRows(fade_depth=0, duration_frames=40, preserve_rows=[NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2]),
	...
	DarkenLayersExceptPaletteRows(fade_depth=50, duration_frames=1, preserve_rows=[NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2]),
	FadeOutMusicToVolume(duration=0, volume=1),
	...
	ActionQueueSync(target=NPC_8, subscript=[
		...
		A_ToggleSubroutineSlots(0x04),
		A_PlaySound(sound=SO033_JUMPING_BOUNCING_FISH, channel=6),
		A_UnknownCommand(bytearray([0x25, 0x00, 0x08, 0x00, 0xFF])),
