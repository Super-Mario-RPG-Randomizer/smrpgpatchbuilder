...
script = ActionScript([
	...
	A_EmbeddedAnimationRoutine(bytearray([0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x00, 0x01, 0x00, 0x00, 0x80, 0x03, 0x80])),
	A_UnknownCommand(bytearray([0x2F, 0x00, 0x08, 0x80, 0x00, 0x01, 0x00])),
