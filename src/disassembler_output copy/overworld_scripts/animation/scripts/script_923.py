...
script = ActionScript([
	...
	A_JmpIfVarEqualsConst(PRIMARY_TEMP_700C, 0, ["ACTION_923_toggle_subroutine_slots_10"]),
	...
	A_ToggleSubroutineSlots(0x05, identifier="ACTION_923_toggle_subroutine_slots_10"),
	A_EmbeddedAnimationRoutine(bytearray([0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x80])),
	A_EmbeddedAnimationRoutine(bytearray([0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x80])),
