...
script = ActionScript([
	...
	A_JmpIfVarEqualsConst(PRIMARY_TEMP_700C, 29, ["ACTION_712_toggle_subroutine_slots_7"]),
	...
	A_ReturnQueue(),
	A_ToggleSubroutineSlots(0x03, identifier="ACTION_712_toggle_subroutine_slots_7"),
