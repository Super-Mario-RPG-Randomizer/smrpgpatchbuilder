...
script = ActionScript([
	...
	A_EmbeddedAnimationRoutine(bytearray([0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x18, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x80]), identifier="ACTION_412_embedded_animation_routine_7"),
	...
	A_EmbeddedAnimationRoutine(bytearray([0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x18, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x80]), identifier="ACTION_412_embedded_animation_routine_11"),
	A_JmpIfRandom1of2(["ACTION_412_embedded_animation_routine_15"], identifier="ACTION_412_jmp_if_random_above_128_12"),
	A_EmbeddedAnimationRoutine(bytearray([0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x08, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x80])),
	A_Jmp(["ACTION_412_jmp_if_object_within_range_same_z_16"]),
	A_EmbeddedAnimationRoutine(bytearray([0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x0C, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x80]), identifier="ACTION_412_embedded_animation_routine_15"),
	...
	A_BPL2627(),
	A_VisibilityOn(),
	A_UnknownCommand(bytearray([0x30, 0x00, 0x02])),
	A_UnknownCommand(bytearray([0x29, 0x00])),
