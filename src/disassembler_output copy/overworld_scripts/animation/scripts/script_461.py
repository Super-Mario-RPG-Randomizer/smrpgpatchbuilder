...
script = ActionScript([
	...
	A_SetSubroutineXTargets(65024, 512),
	...
	A_SetSpriteSequence(index=9, is_sequence=True, looping=True),
	A_ToggleSubroutineSlots(0x07),
	A_SetSubroutineXTargets(512, 32),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(512, 65152),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_BPL262728(),
	A_ResetProperties(),
	...
	A_SetSpriteSequence(index=9, is_sequence=True, looping=True),
	A_ToggleSubroutineSlots(0x07),
	A_SetSubroutineXTargets(65024, 0),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(65024, 0),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(65408, 384),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_BPL262728(),
	A_ResetProperties(),
	...
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(0, 65024),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_BPL262728(),
	A_ResetProperties(),
