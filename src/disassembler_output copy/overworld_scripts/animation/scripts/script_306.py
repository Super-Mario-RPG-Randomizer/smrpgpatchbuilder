...
script = ActionScript([
	...
	A_EmbeddedAnimationRoutine(bytearray([0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x08, 0x00, 0x01, 0xF0, 0xFF, 0x00, 0x10, 0x80])),
	A_EmbeddedAnimationRoutine(bytearray([0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x04, 0x00, 0x01, 0xF8, 0xFF, 0x00, 0x10, 0x80])),
	A_ShiftZDownSteps(5),
	A_BPL262728(),
	A_VisibilityOff(),
	A_ReturnQueue()
