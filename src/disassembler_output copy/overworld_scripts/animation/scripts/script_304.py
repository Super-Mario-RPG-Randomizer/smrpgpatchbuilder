...
script = ActionScript([
	...
	A_EmbeddedAnimationRoutine(bytearray([0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x08, 0x00, 0x00, 0x10, 0x80])),
	A_EmbeddedAnimationRoutine(bytearray([0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x01, 0x04, 0x00, 0x00, 0x10, 0x80])),
	A_ShiftZUpSteps(6),
	A_BPL262728(),
	A_VisibilityOff(),
	A_ReturnQueue()
