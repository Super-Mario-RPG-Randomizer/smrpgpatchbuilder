...
script = AnimationScriptBlock(expected_size=165, expected_beginning=0x357FF8, script=[
	...
	MoveObject(speed=17, start_position=-257, end_position=256, apply_to_z=True, should_set_start_position=True, should_set_end_position=True, should_set_speed=True, identifier="command_0x358009"),
	...
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=32),
	MoveObject(speed=17, start_position=256, end_position=-257, apply_to_z=True, should_set_start_position=True, should_set_end_position=True, should_set_speed=True),
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=32, identifier="command_0x358035"),
	...
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=32),
	MoveObject(speed=17, start_position=-257, end_position=256, apply_to_z=True, should_set_start_position=True, should_set_end_position=True, should_set_speed=True),
	Jmp(["command_0x358035"]),
	ResetTargetMappingMemory(identifier="command_0x35806F"),
	...
	SpriteSequence(sequence=0, looping_off=True, identifier="command_0x358081"),
	...
	RunSubroutine(["command_0x352163"], identifier="command_0x358091"),
