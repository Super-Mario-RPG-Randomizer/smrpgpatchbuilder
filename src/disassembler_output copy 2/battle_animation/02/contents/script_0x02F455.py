...
script = AnimationScriptBlock(expected_size=76, expected_beginning=0x02F455, script=[
	DefineObjectQueue(["command_0x02F461", "command_0x02F462", "command_0x02F473", "command_0x02F47C", "command_0x02F484", "command_0x02F491"], identifier="command_0x02F455"),
	...
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=10, identifier="command_0x02F468"),
	...
	Jmp(["command_0x02F468"]),
	InitializeBonusMessageSequence(identifier="command_0x02F47C"),
	...
	PauseScriptUntilBonusMessageComplete(),
	ReturnSubroutine(),
	InitializeBonusMessageSequence(identifier="command_0x02F491"),
