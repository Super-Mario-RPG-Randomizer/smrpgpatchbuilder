...
script = EventScript([
	...
	JmpIfBitClear(DO_SECOND_KEEP_BOSS_FIGHT_FROM_STAR_PIECE, ["EVENT_2409_set_var_to_const_5"]),
	...
	Return(),
	Return(),
	JmpIfBitClear(DO_SECOND_KEEP_BOSS_FIGHT_FROM_STAR_PIECE, ["EVENT_2409_set_var_to_const_26"], identifier="EVENT_2409_jmp_if_bit_clear_24"),
	SetSyncActionScript(NPC_7, A0690_OPENING_CHEST),
	...
	FadeInFromBlack(sync=False),
	Return(),
	JmpIfBitClear(DO_SECOND_KEEP_BOSS_FIGHT_FROM_STAR_PIECE, ["EVENT_2409_set_var_to_const_39"], identifier="EVENT_2409_jmp_if_bit_clear_37"),
	SetSyncActionScript(NPC_7, A0690_OPENING_CHEST),
	...
	RunBackgroundEvent(event_id=E2592_ABYSS_FALL_OFF_BEFORE_FIRST_BOSS, return_on_level_exit=True),
	Return(),
	JmpIfBitClear(DO_SECOND_KEEP_BOSS_FIGHT_FROM_STAR_PIECE, ["EVENT_2409_set_var_to_const_59"], identifier="EVENT_2409_jmp_if_bit_clear_57"),
	SetSyncActionScript(NPC_7, A0690_OPENING_CHEST),
