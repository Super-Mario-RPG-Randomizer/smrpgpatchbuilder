...
script = EventScript([
	...
	PaletteSet(palette_set_starts_at=111, from_row=MARIO_PALETTE),
	...
	PaletteSet(palette_set_starts_at=111, from_row=MARIO_PALETTE, identifier="EVENT_2112_palette_set_13"),
