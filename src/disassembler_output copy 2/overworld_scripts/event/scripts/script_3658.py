...
script = EventScript([
	...
	ActionQueueAsync(target=NPC_12, subscript=[
		A_UnknownCommand(bytearray([0xC8, 0x9E])),
	...
	RememberLastObject(),
	Pause(120),
	PaletteSet(palette_set_starts_at=105, from_row=NPC_PALETTE_ROW_6),
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=113, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=122, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=123, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=124, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=125, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=126, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=127, row=LEVEL_PALETTE_7),
	Pause(30),
	...
	Pause(270),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=114, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=130, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=131, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=132, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=133, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=134, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=135, row=LEVEL_PALETTE_7),
