...
script = EventScript([
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=26, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=26, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=26, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=26, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=26, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=26, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=26, row=LEVEL_PALETTE_7),
	Pause(16),
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=97, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=98, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=99, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=100, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=101, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=102, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=103, row=LEVEL_PALETTE_7),
	Pause(32),
	UnfreezeAllNPCs(),
