...
script = EventScript([
	...
	PaletteSet(palette_set_starts_at=142, from_row=MARIO_PALETTE, identifier="EVENT_663_palette_set_200"),
	ActionQueueSync(target=NPC_13, subscript=[
		A_TransferToXYZF(x=22, y=72, z=2, direction=EAST),
	...
	PaletteSet(palette_set_starts_at=84, from_row=MARIO_PALETTE),
	ActionQueueSync(target=MARIO, subscript=[
		A_FaceSouth(),
		A_Pause(2),
		A_FaceSoutheast()
