...
script = EventScript([
	...
	Pause(1),
	DarkenLayersExceptPaletteRows(fade_depth=25, duration_frames=32, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2, NPC_PALETTE_ROW_3, NPC_PALETTE_ROW_5]),
	Pause(60),
	...
	ActionQueueSync(target=NPC_0, subscript=[
		...
		A_EmbeddedAnimationRoutine(bytearray([0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x40, 0x00, 0x01, 0xE0, 0xFF, 0x70, 0xFE, 0x80])),
		A_EmbeddedAnimationRoutine(bytearray([0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x01, 0xF0, 0xFF, 0x70, 0xFE, 0x80])),
		A_Pause(512),
		A_BPL262728()
	]),
	ActionQueueAsync(target=NPC_1, subscript=[
	...
	DarkenLayersExceptPaletteRows(fade_depth=0, duration_frames=48, preserve_rows=[NPC_PALETTE_ROW_3, NPC_PALETTE_ROW_5]),
	SetSyncActionScript(NPC_1, A0120_EMBEDDED_ROUTINE),
	Pause(60),
	SetSyncActionScript(NPC_1, A0015_DO_NOTHING),
	ActionQueueAsync(target=NPC_1, subscript=[
