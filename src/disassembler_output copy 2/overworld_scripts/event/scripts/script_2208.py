...
script = EventScript([
	...
	Return(),
	PaletteSet(palette_set_starts_at=138, from_row=NPC_PALETTE_ROW_3, identifier="EVENT_2208_palette_set_4"),
	PaletteSet(palette_set_starts_at=139, from_row=NPC_PALETTE_ROW_1),
