...
script = EventScript([
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=57, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=58, row=LEVEL_PALETTE_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=59, row=LEVEL_PALETTE_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=60, row=LEVEL_PALETTE_4),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=61, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=62, row=LEVEL_PALETTE_6),
	PaletteSetMorphs(palette_type=FADE_TO, duration=10, palette_set=63, row=LEVEL_PALETTE_7),
	Pause(24),
