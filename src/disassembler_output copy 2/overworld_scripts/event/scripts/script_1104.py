...
script = EventScript([
	...
	DeactivateSoundChannels(set([]), identifier="EVENT_1104_deactivate_sound_channels_5"),
	...
	FadeInFromBlack(sync=False),
	Return(),
	DeactivateSoundChannels(set([0, 1, 2, 3]), identifier="EVENT_1104_deactivate_sound_channels_13"),
	FadeInFromBlack(sync=False),
	Return()
])
