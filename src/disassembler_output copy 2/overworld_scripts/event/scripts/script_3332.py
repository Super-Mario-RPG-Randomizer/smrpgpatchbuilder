...
script = EventScript([
	...
	Pause(1),
	DarkenLayersExceptPaletteRows(fade_depth=25, duration_frames=32, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2, NPC_PALETTE_ROW_3, NPC_PALETTE_ROW_4, NPC_PALETTE_ROW_5, NPC_PALETTE_ROW_6, NPC_PALETTE_ROW_7]),
	Pause(60),
	...
	ActionQueueSync(target=NPC_0, subscript=[
		...
		A_EmbeddedAnimationRoutine(bytearray([0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x40, 0x00, 0x01, 0xE8, 0xFF, 0x70, 0xFE, 0x80])),
		A_EmbeddedAnimationRoutine(bytearray([0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x01, 0xF4, 0xFF, 0x70, 0xFE, 0x80])),
		A_Pause(682),
		A_BPL262728()
	]),
	ActionQueueSync(target=SCREEN_FOCUS, subscript=[
	...
	DarkenLayersExceptPaletteRows(fade_depth=50, duration_frames=32, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2, NPC_PALETTE_ROW_3, NPC_PALETTE_ROW_4, NPC_PALETTE_ROW_5, NPC_PALETTE_ROW_6, NPC_PALETTE_ROW_7]),
	ActionQueueSync(target=MARIO, subscript=[
		A_Pause(128),
