...
script = EventScript([
	JmpToEvent(E4001_CLONE_RESERVED),
	Return(),
	...
	ActionQueueSync(target=SCREEN_FOCUS, subscript=[
		...
		A_Pause(224),
		A_ToggleSubroutineSlots(0x02),
		A_EmbeddedAnimationRoutine(bytearray([0x27, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])),
		A_Pause(64),
		A_BPL262728()
	]),
	Pause(64),
