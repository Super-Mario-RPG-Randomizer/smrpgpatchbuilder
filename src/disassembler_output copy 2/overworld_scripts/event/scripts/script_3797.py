...
script = EventScript([
	...
	ActionQueueSync(target=SCREEN_FOCUS, subscript=[
		...
		A_SetSubroutineXTargets(65520, 65472),
		A_Pause(64),
		A_BPL262728()
	]),
	ActionQueueSync(target=MARIO, subscript=[
	...
	ActionQueueSync(target=NPC_19, subscript=[
		A_SequenceLoopingOn(),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(128, 65504),
		A_Pause(140),
		A_BPL262728(),
	...
	ActionQueueSync(target=NPC_20, subscript=[
		...
		A_SequenceLoopingOn(),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(48, 65408),
		A_Pause(64),
		A_BPL262728(),
		A_FixedFCoordOff(),
		A_SequenceLoopingOff(),
	...
	ActionQueueSync(target=NPC_21, subscript=[
		...
		A_SequenceLoopingOn(),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(128, 65408),
		A_Pause(88),
		A_BPL262728(),
		A_SequenceLoopingOff()
	]),
	...
	ActionQueueSync(target=NPC_17, subscript=[
		...
		A_VisibilityOn(),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(64000, 64000),
		A_Pause(32),
		A_BPL262728(),
		A_VisibilityOff()
	...
	ActionQueueSync(target=NPC_18, subscript=[
		...
		A_VisibilityOn(),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(64544, 64480),
		A_Pause(32),
		A_BPL262728(),
		A_VisibilityOff()
	...
	ActionQueueSync(target=NPC_15, subscript=[
		...
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(1504, 63712),
		A_Pause(32),
		A_BPL262728(),
		A_VisibilityOff()
	...
	ActionQueueSync(target=NPC_16, subscript=[
		...
		A_VisibilityOn(),
		A_ToggleSubroutineSlots(0x03),
		A_SetSubroutineXTargets(65024, 63488),
		A_Pause(32),
		A_BPL262728(),
		A_VisibilityOff()
	...
	StartAsyncEmbeddedActionScript(target=NPC_6, prefix=0xF1, subscript=[
		...
		A_SetSubroutineXTargets(65432, 65480),
		A_Pause(30),
		A_BPL262728()
	]),
	SetSyncActionScript(NPC_6, A0120_EMBEDDED_ROUTINE),
	...
	StartAsyncEmbeddedActionScript(target=NPC_6, prefix=0xF1, subscript=[
		...
		A_SetSubroutineXTargets(65424, 256),
		A_Pause(30)
	]),
	SetSyncActionScript(NPC_6, A0120_EMBEDDED_ROUTINE),
	ActionQueueSync(target=NPC_0, subscript=[
	...
	StartAsyncEmbeddedActionScript(target=NPC_6, prefix=0xF1, subscript=[
		...
		A_SetSubroutineXTargets(32, 65328),
		A_Pause(30)
	]),
	SetSyncActionScript(NPC_6, A0120_EMBEDDED_ROUTINE),
	ActionQueueAsync(target=MARIO, subscript=[
	...
	PaletteSet(palette_set_starts_at=163, from_row=MARIO_PALETTE),
	PaletteSet(palette_set_starts_at=164, from_row=NPC_PALETTE_ROW_1),
	PaletteSet(palette_set_starts_at=166, from_row=NPC_PALETTE_ROW_2),
	PaletteSet(palette_set_starts_at=167, from_row=NPC_PALETTE_ROW_3),
	PaletteSet(palette_set_starts_at=165, from_row=NPC_PALETTE_ROW_5),
	ActionQueueSync(target=SCREEN_FOCUS, subscript=[
		A_SetWalkingSpeed(FASTEST),
		A_WalkEastPixels(16),
		A_Walk1StepNorth()
	...
	Pause(404),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=161, row=LEVEL_PALETTE_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=162, row=LEVEL_PALETTE_5),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=84, row=MARIO_PALETTE),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=85, row=NPC_PALETTE_ROW_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=86, row=NPC_PALETTE_ROW_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=141, row=NPC_PALETTE_ROW_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=140, row=NPC_PALETTE_ROW_5),
	PauseScriptUntilEffectDone(),
	Pause(216),
