...
script = EventScript([
	...
	ActionQueueAsync(target=NPC_2, subscript=[
		...
		A_SetSubroutineXTargets(152, 112),
		A_Pause(13),
	...
	ActionQueueAsync(target=NPC_2, subscript=[
		...
		A_BPL262728(),
		A_ToggleSubroutineSlots(0x07),
		A_UnknownCommand(bytearray([0x25, 0x20, 0x07, 0x80, 0xFF])),
		A_SetSubroutineXTargets(65216, 160),
		A_Pause(14),
		A_SetSpriteSequence(index=0, is_sequence=True, looping=True),
		A_Pause(14),
		A_BPL262728(),
	...
	ActionQueueAsync(target=NPC_2, subscript=[
		...
		A_ToggleSubroutineSlots(0x07),
		A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
		A_SetSubroutineXTargets(65384, 65424),
		A_Pause(13),
		A_SetSpriteSequence(index=0, is_sequence=True, looping=True),
		A_Pause(14),
		A_BPL262728(),
	...
	PauseScriptUntilEffectDone(),
	UnknownCommand(bytearray([0xFD, 0x8F, 0x01])),
	Pause(50),
