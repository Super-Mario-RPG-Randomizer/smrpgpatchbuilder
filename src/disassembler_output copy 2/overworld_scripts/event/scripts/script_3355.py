...
script = EventScript([
	...
	SetBit(TEMP_7044_7),
	DarkenLayersExceptPaletteRows(fade_depth=0, duration_frames=8, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2]),
	Pause(8),
	...
	DarkenLayersExceptPaletteRows(fade_depth=50, duration_frames=8, preserve_rows=[MARIO_PALETTE, NPC_PALETTE_ROW_1, NPC_PALETTE_ROW_2]),
