...
script = EventScript([
	...
	PaletteSetMorphs(palette_type=NOTHING, duration=2, palette_set=214, row=NPC_PALETTE_ROW_3),
	Pause(60),
	...
	DarkenLayersExceptPaletteRows(fade_depth=50, duration_frames=30, preserve_rows=[MARIO_PALETTE]),
	PauseScriptUntilEffectDone(),
