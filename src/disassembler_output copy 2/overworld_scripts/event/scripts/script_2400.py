...
script = EventScript([
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_SetSubroutineXTargets(128, 128),
		A_UnknownCommand(bytearray([0x25, 0x00, 0x0A, 0xD0, 0xFF])),
		A_Pause(104),
		A_BPL262728()
	]),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_VisibilityOn(),
		A_ToggleSubroutineSlots(0x07),
		A_SetSubroutineXTargets(65280, 128),
		A_UnknownCommand(bytearray([0x25, 0x00, 0x09, 0xD0, 0xFF])),
		A_Pause(104),
		A_BPL262728()
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_VisibilityOn(),
		A_ToggleSubroutineSlots(0x07),
		A_SetSubroutineXTargets(256, 65408),
		A_UnknownCommand(bytearray([0x25, 0x00, 0x09, 0xD0, 0xFF])),
		A_Pause(104),
		A_BPL262728()
