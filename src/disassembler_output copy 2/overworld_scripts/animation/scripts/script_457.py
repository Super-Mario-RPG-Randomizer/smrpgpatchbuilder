...
script = ActionScript([
	...
	A_SetSubroutineXTargets(0, 384),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(65152, 0, identifier="ACTION_457_set_subroutine_x_targets_15"),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(65280, 256),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_BPL262728(),
	A_Pause(16),
	...
	A_ToggleSubroutineSlots(0x07),
	A_SetSubroutineXTargets(304, 0),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(256, 65280),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_BPL262728(),
	A_Pause(16),
	...
	A_SetSpriteSequence(index=9, is_sequence=True, looping=True),
	A_ToggleSubroutineSlots(0x07),
	A_Jmp(["ACTION_457_set_subroutine_x_targets_15"])
])
