...
script = ActionScript([
	...
	A_StartLoopNTimes(2),
	A_SetSubroutineXTargets(192, 160),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1, identifier="ACTION_481_start_loop_n_times_21"),
	A_SetSubroutineXTargets(65440, 64),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1),
	A_SetSubroutineXTargets(65440, 65472),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1),
	A_SetSubroutineXTargets(96, 65472),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1),
	A_SetSubroutineXTargets(96, 64),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
