...
script = ActionScript([
	...
	A_JmpIfVarEqualsConst(PRIMARY_TEMP_700C, 21, ["ACTION_942_toggle_subroutine_slots_43"]),
	...
	A_ToggleSubroutineSlots(0x04, identifier="ACTION_942_toggle_subroutine_slots_43"),
