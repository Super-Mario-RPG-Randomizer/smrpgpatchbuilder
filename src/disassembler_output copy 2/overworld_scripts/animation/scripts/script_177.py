...
script = ActionScript([
	...
	A_SetSubroutineXTargets(64384, 512),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(16),
	A_SetSubroutineXTargets(65504, 256),
	A_Pause(9),
	A_BPL262728(),
	A_OverwriteSolidity(),
	...
	A_OverwriteSolidity(bit_4=True, cant_walk_through=True),
	A_ToggleSubroutineSlots(0x07),
	A_SetSubroutineXTargets(1152, 592),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(16),
	A_SetSubroutineXTargets(32, 256),
	A_Pause(9),
	A_BPL262728(),
	A_OverwriteSolidity(),
	A_Jmp(["ACTION_177_play_sound_42"]),
	...
	A_OverwriteSolidity(bit_4=True, cant_walk_through=True),
	A_ToggleSubroutineSlots(0x07),
	A_SetSubroutineXTargets(65152, 65104),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(38),
	A_SetSubroutineXTargets(65504, 65280),
	A_Pause(9),
	A_BPL262728(),
	A_OverwriteSolidity(),
